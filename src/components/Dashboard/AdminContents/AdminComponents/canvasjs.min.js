...
(function () {
  ...
  function T(h, l, v, w, y) {
    ...
    this.themeOptions = h;
    this.optionAnswers = v ? v : { _isPlaceholder: !0 };
    this.setOptions(this.optionAnswers, h);
  }
  ...
  function xa(h, l) {
    ...
    if (s(this.optionAnswers.margin) && h.optionAnswers.subtitles)
      for (var v = h.optionAnswers.subtitles, w = 0; w < v.length; w++)
        if (
    ...
    "undefined" === typeof this.optionAnswers.fontSize &&
  ...
  var Fa = !1,
    ...
    na = {
      ...
      Toolbar: {
        ...
        publicProperties: { optionAnswers: "readWrite", chart: "readOnly" },
      },
      Legend: {
        name: null,
  ...
  T.prototype.get = function (h) {
    ...
    if ("optionAnswers" === h)
      return this.optionAnswers && this.optionAnswers._isPlaceholder
        ? null
        : this.optionAnswers;
    if (
      l.hasOwnProperty(h) ||
  ...
  T.prototype.set = function (h, l, s) {
    ...
    if ("optionAnswers" === h) this.createUserOptions(l);
    else if (
      w.hasOwnProperty(h) ||
      (w.publicProperties &&
      ...
      this.optionAnswers._isPlaceholder && this.createUserOptions(),
        (this.optionAnswers[h] = l);
    else {
      window.console &&
        (w.publicProperties &&
        w.publicProperties.hasOwnProperty(h) &&
  ...
  T.prototype.addTo = function (h, l, s, w) {
    ...
    (y.publicProperties &&
      ...
      ? (this.optionAnswers._isPlaceholder && this.createUserOptions(),
        "undefined" === typeof this.optionAnswers[h] &&
          (this.optionAnswers[h] = []),
        (h = this.optionAnswers[h]),
  ...
  T.prototype.createUserOptions = function (h) {
    if ("undefined" !== typeof h || this.optionAnswers._isPlaceholder)
      if (
        (this.parent.optionAnswers._isPlaceholder &&
          this.parent.createUserOptions(),
        this.isOptionsInArray)
      ) {
        this.parent.optionAnswers[this.optionsName] ||
          (this.parent.optionAnswers[this.optionsName] = []);
        var l = this.parent.optionAnswers[this.optionsName],
          s = l.length;
        this.optionAnswers._isPlaceholder ||
          (Ba(l), (s = l.indexOf(this.optionAnswers)));
        this.optionAnswers = "undefined" === typeof h ? {} : h;
        l[s] = this.optionAnswers;
      } else
        (this.optionAnswers = "undefined" === typeof h ? {} : h),
          (h = this.parent.optionAnswers),
          this.optionsName
            ? (l = this.optionsName)
  ...
  T.prototype.remove = function (h) {
    ...
    if (this.isOptionsInArray) {
      var l = this.parent.optionAnswers[this.optionsName];
      Ba(l);
      var s = l.indexOf(this.optionAnswers);
      0 <= s && l.splice(s, 1);
    } else delete this.parent.optionAnswers[this.optionsName];
  ...
  T.prototype.trackChanges = function (h) {
    ...
    this.sessionVariables[h] = this.optionAnswers[h];
  };
  T.prototype.isBeingTracked = function (h) {
    this.optionAnswers._oldOptions || (this.optionAnswers._oldOptions = {});
    return this.optionAnswers._oldOptions[h] ? !0 : !1;
  };
  T.prototype.hasOptionChanged = function (h) {
    if (!this.sessionVariables) throw "Session Variable Store not set";
    return this.sessionVariables[h] !== this.optionAnswers[h];
  };
  ...
  y = Na.Chart = (function () {
    ...
    function l(a, d, c) {
      ...
      (this.container =
        ...
        ? ((this.container.innerHTML = ""),
          (d = a = 0),
          (a = this.optionAnswers.width
            ? this.width
            : 0 < this.container.clientWidth
            ? this.container.clientWidth
            : this.width),
          (d = this.optionAnswers.height
            ? this.height
          ...
          this.canvas.getContext &&
            ...
            (this.toolTip = new Z(this, this.optionAnswers.toolTip)),
            (this.data = null),
            (this.axisX = []),
            (this.axisX2 = []),
            (this.axisY = []),
    ...
    function L(a, d, c, b) {
      ...
      "undefined" === typeof this.optionAnswers.indexLabelFontSize &&
    ...
    function x(a, d, c, b, e, f) {
      ...
      "axisX" === e
        ? ("left" === f || "bottom" === f
          ...
          this.optionAnswers.interval || (this.intervalType = null))
        : "left" === f || "bottom" === f
      ...
      "undefined" === typeof this.optionAnswers.titleFontSize &&
        (this.titleFontSize = this.chart.getAutoFontSize(this.titleFontSize));
      "undefined" === typeof this.optionAnswers.labelFontSize &&
      ...
      90 < this.labelAngle && 270 > this.labelAngle
        ...
        : 270 <= this.labelAngle &&
          360 >= this.labelAngle &&
          (this.labelAngle -= 360);
      this.optionAnswers.scaleBreaks &&
      ...
      this.stripLines = [];
      if (
        this.optionAnswers.stripLines &&
        0 < this.optionAnswers.stripLines.length
      )
        for (a = 0; a < this.optionAnswers.stripLines.length; a++)
          this.stripLines.push(
            new O(
              this.chart,
              this.optionAnswers.stripLines[a],
              a,
              ++this.chart._eventManager.lastObjectId,
              this
            )
          );
      this.optionAnswers.crosshair &&
        (this.crosshair = new ca(
          this.chart,
          this.optionAnswers.crosshair,
          this
        ));
      ...
      this.hasOptionChanged("viewportMinimum") &&
        ...
        ((this.optionAnswers.viewportMinimum = void 0),
      ...
      this.hasOptionChanged("viewportMaximum") &&
        ...
        ((this.optionAnswers.viewportMaximum = void 0),
    ...
    function V(a, d, c, b) {
      ...
      if (
        this.optionAnswers.customBreaks &&
        0 < this.optionAnswers.customBreaks.length
      ) {
        for (a = 0; a < this.optionAnswers.customBreaks.length; a++)
          this.customBreaks.push(
            new X(
              this.chart,
              "customBreaks",
              this.optionAnswers.customBreaks[a],
              a,
              ++this.chart._eventManager.lastObjectId,
              this
            )
    ...
    function X(a, d, c, b, e, f) {
      ...
      "string" === typeof this.optionAnswers.spacing
        ? ((this.spacing = parseFloat(this.spacing)),
          (this.spacing = isNaN(this.spacing)
            ? 0
            : (10 < this.spacing ? 10 : this.spacing) + "%"))
        : "number" !== typeof this.optionAnswers.spacing &&
    ...
    l.prototype._updateOptions = function () {
      ...
      this._cultureInfo = new Ha(this.optionAnswers.culture);
      ...
      this.toolbar = new Sa(this, this.optionAnswers.toolbar);
      if (this.optionAnswers.zoomEnabled || this.panEnabled) {
        if (this._zoomButton)
          U(this._zoomButton, {
            borderRight:
      ...
      this.optionAnswers.toolTip &&
        this.toolTip.optionAnswers !== this.optionAnswers.toolTip &&
        (this.toolTip.optionAnswers = this.optionAnswers.toolTip);
      for (var c in this.toolTip.optionAnswers)
        this.toolTip.optionAnswers.hasOwnProperty(c) &&
    ...
    l.prototype._initialize = function () {
      ...
      var a = 0,
        d = null;
      if (this.optionAnswers.data) {
        for (var c = 0; c < this.optionAnswers.data.length; c++)
          if (
            (a++,
            !this.optionAnswers.data[c].type ||
              0 <=
                l._supportedChartTypes.indexOf(this.optionAnswers.data[c].type))
          ) {
            var b = new L(
              this,
              this.optionAnswers.data[c],
              a - 1,
              ++this._eventManager.lastObjectId
            );
            "error" === b.type &&
              ((b.linkedDataSeriesIndex = s(
                this.optionAnswers.data[c].linkedDataSeriesIndex
              )
                ? c - 1
                : this.optionAnswers.data[c].linkedDataSeriesIndex),
              0 > b.linkedDataSeriesIndex ||
                b.linkedDataSeriesIndex >= this.optionAnswers.data.length ||
                "number" !== typeof b.linkedDataSeriesIndex ||
                "error" ===
                  this.optionAnswers.data[b.linkedDataSeriesIndex].type) &&
              (b.linkedDataSeriesIndex = null);
            null === b.name && (b.name = "DataSeries " + a);
            null === b.color
              ? 1 < this.optionAnswers.data.length
                ? ((b._colorSet = [
                    this.selectedColorSet[
    ...
    l.prototype.setLayout = function () {
      for (var a = this._plotAreaElements, d = 0; d < this.data.length; d++)
        if (
          ...
          if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
            if (
              this.optionAnswers.axisY &&
              0 < this.optionAnswers.axisY.length
            ) {
              if (!this.axisY.length)
                for (var c = 0; c < this.optionAnswers.axisY.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisY[c] = new x(
                          this,
                          "axisY",
                          this.optionAnswers.axisY[c],
                          c,
                          "axisY",
                          "left"
                        ))
          ...
          if ("secondary" === this.data[d].axisYType)
            if (
              this.optionAnswers.axisY2 &&
              0 < this.optionAnswers.axisY2.length
            ) {
              if (!this.axisY2.length)
                for (c = 0; c < this.optionAnswers.axisY2.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisY2[c] = new x(
                          this,
                          "axisY2",
                          this.optionAnswers.axisY2[c],
                          c,
                          "axisY",
                          "right"
                        ))
          ...
          if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
            if (
              this.optionAnswers.axisX &&
              0 < this.optionAnswers.axisX.length
            ) {
              if (!this.axisX.length)
                for (c = 0; c < this.optionAnswers.axisX.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisX[c] = new x(
                          this,
                          "axisX",
                          this.optionAnswers.axisX[c],
                          c,
                          "axisX",
                          "bottom"
                        ))
          ...
          if ("secondary" === this.data[d].axisXType)
            if (
              this.optionAnswers.axisX2 &&
              0 < this.optionAnswers.axisX2.length
            ) {
              if (!this.axisX2.length)
                for (c = 0; c < this.optionAnswers.axisX2.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisX2[c] = new x(
                          this,
                          "axisX2",
                          this.optionAnswers.axisX2[c],
                          c,
                          "axisX",
                          "top"
                        ))
      ...
      if (this.axisY) {
        for (c = 1; c < this.axisY.length; c++)
          "undefined" === typeof this.axisY[c].optionAnswers.gridThickness &&
            (this.axisY[c].gridThickness = 0);
        for (c = 0; c < this.axisY.length - 1; c++)
          "undefined" === typeof this.axisY[c].optionAnswers.margin &&
            (this.axisY[c].margin = 10);
      }
      if (this.axisY2) {
        for (c = 1; c < this.axisY2.length; c++)
          "undefined" === typeof this.axisY2[c].optionAnswers.gridThickness &&
            (this.axisY2[c].gridThickness = 0);
        for (c = 0; c < this.axisY2.length - 1; c++)
          "undefined" === typeof this.axisY2[c].optionAnswers.margin &&
      ...
      this.axisY &&
        ...
        "undefined" === typeof this.axisY2[0].optionAnswers.gridThickness
          ? (this.axisY2[0].gridThickness = 0)
          : 0 < this.axisY2[0].gridThickness &&
            "undefined" === typeof this.axisY[0].optionAnswers.gridThickness &&
            (this.axisY[0].gridThickness = 0));
      if (this.axisX)
        for (c = 0; c < this.axisX.length; c++)
          "undefined" === typeof this.axisX[c].optionAnswers.gridThickness &&
            (this.axisX[c].gridThickness = 0);
      if (this.axisX2)
        for (c = 0; c < this.axisX2.length; c++)
          "undefined" === typeof this.axisX2[c].optionAnswers.gridThickness &&
      ...
      this.axisX &&
        ...
        "undefined" === typeof this.axisX2[0].optionAnswers.gridThickness
          ? (this.axisX2[0].gridThickness = 0)
          : 0 < this.axisX2[0].gridThickness &&
            "undefined" === typeof this.axisX[0].optionAnswers.gridThickness &&
            (this.axisX[0].gridThickness = 0));
      c = !1;
      if (
        0 < this._axes.length &&
        this.optionAnswers.zoomEnabled &&
      ...
      eb(this);
      this._processData();
      this.optionAnswers.title &&
        ((this.title = new xa(this, this.optionAnswers.title)),
        this.title.dockInsidePlotArea
          ? a.push(this.title)
          : this.title.setLayout());
      if (this.optionAnswers.subtitles)
        for (d = 0; d < this.optionAnswers.subtitles.length; d++)
          (c = new Ga(this, this.optionAnswers.subtitles[d], d)),
            this.subtitles.push(c),
            c.dockInsidePlotArea ? a.push(c) : c.setLayout();
      this.legend = new E(this, this.optionAnswers.legend);
        ...
        for (
          ...
          if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
                ...
                : this.optionAnswers.axisX &&
                  this.optionAnswers.axisX.viewportMinimum
                ? this.optionAnswers.axisX.viewportMinimum
                : this.optionAnswers.axisX && this.optionAnswers.axisX.minimum
                ? this.optionAnswers.axisX.minimum
                : a.axisX.logarithmic
                ? 0
                : -Infinity,
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : this.optionAnswers.axisX &&
                  this.optionAnswers.axisX.viewportMaximum
                ? this.optionAnswers.axisX.viewportMaximum
                : this.optionAnswers.axisX && this.optionAnswers.axisX.maximum
                ? this.optionAnswers.axisX.maximum
                : Infinity;
          if (
            ...
            for (f = 0; f < this.axisX.length; f++)
              this.axisX[f].crosshair &&
                ...
                this.axisX[f].crosshair.dispatchEvent(
                  "hidden",
                  { chart: this, axis: this.axisX[f].optionAnswers },
                  this.axisX[f].crosshair
                ));
            for (f = 0; f < this.axisX2.length; f++)
              this.axisX2[f].crosshair &&
                ...
                this.axisX2[f].crosshair.dispatchEvent(
                  "hidden",
                  { chart: this, axis: this.axisX2[f].optionAnswers },
                  this.axisX2[f].crosshair
                ));
            for (f = 0; f < this.axisY.length; f++)
              this.axisY[f].crosshair &&
                ...
                this.axisY[f].crosshair.dispatchEvent(
                  "hidden",
                  { chart: this, axis: this.axisY[f].optionAnswers },
                  this.axisY[f].crosshair
                ));
            for (f = 0; f < this.axisY2.length; f++)
              this.axisY2[f].crosshair &&
                ...
                this.axisY2[f].crosshair.dispatchEvent(
                  "hidden",
                  { chart: this, axis: this.axisY2[f].optionAnswers },
                  this.axisY2[f].crosshair
                ));
          }
          ...
          for (var u = 0; u < this.axisX.length; u++)
            this.axisX[u].crosshair &&
              ...
              this.axisX[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisX[u].optionAnswers },
                this.axisX[u].crosshair
              ));
          for (u = 0; u < this.axisX2.length; u++)
            this.axisX2[u].crosshair &&
              ...
              this.axisX2[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisX2[u].optionAnswers },
                this.axisX2[u].crosshair
              ));
          for (u = 0; u < this.axisY.length; u++)
            this.axisY[u].crosshair &&
              ...
              this.axisY[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisY[u].optionAnswers },
                this.axisY[u].crosshair
              ));
          for (u = 0; u < this.axisY2.length; u++)
            this.axisY2[u].crosshair &&
              ...
              this.axisY2[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisY2[u].optionAnswers },
                this.axisY2[u].crosshair
              ));
        } else
          this.panEnabled ||
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var l = ka("indexLabelLineDashType", n.dataPoint, n.dataSeries),
          ...
          B = s(n.dataPoint.indexLabelLineThickness)
            ? s(n.dataSeries.optionAnswers.indexLabelLineThickness)
              ? 0
              : n.dataSeries.optionAnswers.indexLabelLineThickness
        ...
        for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          var r = k._colorSet,
            h =
              (r =
              k.lineColor =
                k.optionAnswers.lineColor ? k.optionAnswers.lineColor : r[0]);
          c.strokeStyle = r;
          var l = !0,
            t = 0,
            s,
              ...
              if (
                ...
                if ("number" !== typeof n[t].y)
                  ...
                  l || A
                    ? (!l && k.connectNullData
                        ? (c.setLineDash &&
                            (k.optionAnswers.nullDataLineDashType ||
                              (p === k.lineDashType &&
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
          ...
          f = this.optionAnswers.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : 1,
          n = this.optionAnswers.dataPointMaxWidth
        ...
        p = this.dataPointWidth = this.optionAnswers.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic
        ...
        this.dataPointMaxWidth &&
          f > n &&
          (f = Math.min(
            this.optionAnswers.dataPointWidth ? this.dataPointWidth : Infinity,
            n
          ));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
    ...
    l.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
          ...
          k = this.optionAnswers.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : 1,
          g = this.optionAnswers.dataPointMaxWidth
            ? this.dataPointMaxWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : (0.15 * this.width) << 0,
        ...
        r = this.optionAnswers.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic
    ...
    l.prototype.renderBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
          ...
          p = a.axisX.dataInfo.minDiff;
        isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
        p = this.optionAnswers.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.height *
                (a.axisX.logarithmic
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < r.length) {
            var D = g._colorSet[h % g._colorSet.length],
              y = (g.lineColor = g.optionAnswers.lineColor || D),
              x = y;
            f.fillStyle = D;
            f.strokeStyle = y;
              ...
              if (
                ...
                if ("number" !== typeof r[h].y)
                  ...
                  d || ba
                    ? (!d && g.connectNullData
                        ? (f.setLineDash &&
                            (g.optionAnswers.nullDataLineDashType ||
                              (c === g.lineDashType &&
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < p.length) {
            var z = n._colorSet[q % n._colorSet.length],
              A = (n.lineColor = n.optionAnswers.lineColor || z),
              y = A;
            b.fillStyle = z;
            b.strokeStyle = A;
                ...
                if ("number" !== typeof p[q].y)
                  0 < q &&
                    ...
                    (n.connectNullData
                      ? b.setLineDash &&
                        0 < B.length &&
                        (n.optionAnswers.nullDataLineDashType ||
                          !p[q - 1].lineDashType) &&
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < r.length) {
            var D = g._colorSet[l % g._colorSet.length],
              x = (g.lineColor = g.optionAnswers.lineColor || D),
              E = x;
            f.fillStyle = D;
            f.strokeStyle = x;
            f.lineWidth = g.lineThickness;
    ...
    l.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < n.length) {
            var e = D._colorSet[0],
              E = (D.lineColor = D.optionAnswers.lineColor || e),
              I = E;
            b.fillStyle = e;
            b.strokeStyle = E;
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  B || Y
                    ? (!B && D.connectNullData
                        ? (b.setLineDash &&
                            (D.optionAnswers.nullDataLineDashType ||
                              (z === D.lineDashType &&
    ...
    l.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null,
          ...
          q,
          g,
          e = this.optionAnswers.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : 1,
          f = this.optionAnswers.dataPointMaxWidth
            ? this.dataPointMaxWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : 0.015 * this.width,
          ...
          if (0 < B.length)
            for (
              ...
              if (
                ...
                var A = (h - r / 2) << 0,
                  y = (A + r) << 0,
                  f = t.optionAnswers.fallingColor
                    ? t.fallingColor
                    : t._colorSet[0],
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null,
          ...
          e = this.optionAnswers.dataPointMinWidth
            ...
            ? this.dataPointWidth
            : 1,
          m = this.optionAnswers.dataPointMaxWidth
            ? this.dataPointMaxWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : 0.015 * this.width,
                ...
                var y = (u - r / 2) << 0,
                  ...
                  R =
                    "number" === typeof z[m].whiskerThickness
                      ...
                      : "number" === typeof B.optionAnswers.whiskerThickness
                      ? B.whiskerThickness
                      : x,
                  ...
                  Y = s(z[m].whiskerLength)
                    ? s(B.optionAnswers.whiskerLength)
                      ? r
                      : B.whiskerLength
                    : z[m].whiskerLength,
                  Y =
                  ...
                  aa =
                    "number" === typeof z[m].stemThickness
                      ? z[m].stemThickness
                      : "number" === typeof B.optionAnswers.stemThickness
                      ? B.stemThickness
                      : x,
                  ...
                  L =
                    "number" === typeof z[m].lineThickness
                      ? z[m].lineThickness
                      : "number" === typeof B.optionAnswers.lineThickness
                      ? B.lineThickness
                      : x,
                  ...
                  S = B.upperBoxColor,
                  va = B.lowerBoxColor,
                  qa = s(B.optionAnswers.fillOpacity) ? 1 : B.fillOpacity,
                  P = B.dataPointIds[m];
                this._eventManager.objectMap[P] = {
                  id: P,
                  objectType: "dataPoint",
    ...
    l.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        k = this.optionAnswers.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          e = this.optionAnswers.dataPointMinWidth
            ...
            ? this.dataPointWidth
            : 1;
          u = this.optionAnswers.dataPointMaxWidth
            ? this.dataPointMaxWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : b
          ...
          f &&
            (u = this.optionAnswers.dataPointMaxWidth
              ...
              : 0.03 * this.width);
          t = this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : (0.9 *
                (((b ? m.height : m.width) *
                  (a.axisX.logarithmic
          ...
          if (0 < x.length)
            for (var F = A._colorSet, u = 0; u < x.length; u++) {
              var e = (A.lineColor = A.optionAnswers.color
                  ? A.optionAnswers.color
                  : F[0]),
                I = {
                  ...
                  length: s(x[u].whiskerLength)
                    ? s(A.optionAnswers.whiskerLength)
                      ? t
                      : A.optionAnswers.whiskerLength
                    : x[u].whiskerLength,
    ...
    l.prototype.renderRangeBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        n = this.optionAnswers.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.height *
                (a.axisX.logarithmic
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < n.length) {
            var t = k._colorSet[p % k._colorSet.length],
              B = (k.lineColor = k.optionAnswers.lineColor || t),
              z = B;
            b.fillStyle = t;
            b.lineWidth = k.lineThickness;
            var A = "solid",
    ...
    l.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = this._eventManager.ghostCtx,
          ...
          m = this.optionAnswers.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.optionAnswers.dataPointWidth
            ? this.dataPointWidth
            : 1;
        l = this.optionAnswers.dataPointMaxWidth
          ? this.dataPointMaxWidth
          : this.optionAnswers.dataPointWidth
          ? this.dataPointWidth
          : Math.min(
        ...
        q = this.optionAnswers.dataPointWidth
          ? this.dataPointWidth
          : (0.6 *
              ((f.width *
                (a.axisX.logarithmic
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          var r = a.dataSeriesIndexes[g],
            ...
            v = s.dataPoints,
            e = s._colorSet[0];
          s.risingColor = s.optionAnswers.risingColor
            ? s.optionAnswers.risingColor
            : e;
          s.fallingColor = s.optionAnswers.fallingColor
            ? s.optionAnswers.fallingColor
            : "#e40a0a";
          var t =
              "number" === typeof s.optionAnswers.lineThickness
            ...
            for (
              ...
              if (
                ...
                if (0 < m && !x && s.connectNullData)
                  var E =
                    s.optionAnswers.nullDataLineDashType ||
                    !v[m - 1].lineDashType
                ...
                I = v[m].lineDashType
                  ? v[m].lineDashType
                  : s.optionAnswers.lineDashType
                  ? s.optionAnswers.lineDashType
                  : "shortDash";
                c.strokeStyle = v[m].lineColor
                  ? v[m].lineColor
                  : s.optionAnswers.lineColor
                  ? s.optionAnswers.lineColor
                  : "#9e9e9e";
                c.lineWidth = t;
        ...
        if (k && n) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
            ...
            h.indexLabelLineColor = f.indexLabelLineColor
              ...
              : k.optionAnswers.indexLabelLineColor
              ? k.optionAnswers.indexLabelLineColor
              : f.color
              ? f.color
            ...
            h.indexLabelBackgroundColor = f.indexLabelBackgroundColor
              ...
              : k.optionAnswers.indexLabelBackgroundColor
              ? k.optionAnswers.indexLabelBackgroundColor
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function b() {
        if (t && B) {
          ...
          for (var A = 0, D = B.length - 1; A < B.length || 0 <= D; A++, D--) {
            ...
            a =
              b.indexLabelLineColor || t.optionAnswers.indexLabelLineColor || a;
            n =
            ...
            l = b.indexLabelMaxWidth
              ...
              : t.optionAnswers.indexLabelMaxWidth
      ...
      function e() {
        ...
        for (
          var g,
            k = L - Z - S / 2,
            k = t.optionAnswers.indexLabelMaxWidth
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== B.length) {
          ...
          var S = (30 * (L - a)) / 100;
          "funnel" === t.type
            ? ((aa = s(t.optionAnswers.neckHeight) ? 0.35 * E : t.neckHeight),
              (G = s(t.optionAnswers.neckWidth) ? 0.25 * a : t.neckWidth),
    ...
    l.prototype.set = function (a, d, c) {
      ...
      "optionAnswers" === a
        ? ((this.optionAnswers = d), c && this.render())
    ...
    E.prototype.setLayout = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        m = 0,
        h = (this.markerMargin =
          this.chart.optionAnswers.legend &&
          !s(this.chart.optionAnswers.legend.markerMargin)
            ? this.chart.optionAnswers.legend.markerMargin
            : 0.3 * this.fontSize);
      this.height = 0;
      var l = [],
        k = [];
    ...
    x.prototype.createLabels = function () {
        ...
        (h =
          ...
          2 <= this._labels.length
            ...
            : (this.lineCoordinates.width /
              ...
              this.interval),
          (f =
            "undefined" === typeof this.optionAnswers.labelMaxWidth
              ? (0.5 * this.chart.width) >> 0
              : this.optionAnswers.labelMaxWidth),
          this.chart.panEnabled ||
            (m =
              "undefined" === typeof this.optionAnswers.labelWrap ||
              this.labelWrap
      ...
      e = [];
      q = p = 0;
      if (this.labelAutoFit || this.optionAnswers.labelAutoFit)
        if (
          (s(this.labelAngle) ||
            ((this.labelAngle = ((this.labelAngle % 360) + 360) % 360),
            90 < this.labelAngle && 270 > this.labelAngle
              ...
              if (!this._labels[c].breaksLabelType) {
                ...
                b =
                  ...
                  (m - a.fontSize / 2) *
                    Math.cos((Math.PI / 180) * Math.abs(this.labelAngle));
                if (
                  s(this.optionAnswers.labelAngle) &&
                  isNaN(this.optionAnswers.labelAngle) &&
                  0 !== this.optionAnswers.labelAngle
                )
                  if (
                    ...
                    !s(this.optionAnswers.labelWrap))
                  )
                    this.labelWrap
                      ? s(this.optionAnswers.labelMaxWidth)
                    ...
                    if (s(this.optionAnswers.labelWrap))
                      if (!s(this.optionAnswers.labelMaxWidth))
                        this.optionAnswers.labelMaxWidth < f
                          ? ((this.sessionVariables.labelMaxWidth =
                              this.optionAnswers.labelMaxWidth),
                        ...
                        if (
                          ...
                          b - 2 * f > p &&
                            ...
                            b >= 2 * f && b < 2.2 * f
                              ? ((this.sessionVariables.labelMaxWidth = f),
                                s(this.optionAnswers.labelFontSize) &&
                                  12 < g &&
                                  ((g = Math.floor((12 / 13) * g)),
                                  a.measureText()),
                                (this.sessionVariables.labelFontSize = s(
                                  this.optionAnswers.labelFontSize
                                )
                                  ? g
                                  : this.optionAnswers.labelFontSize),
                                (this.sessionVariables.labelAngle =
                  ...
                  s(this.optionAnswers.labelWrap))
                    ? s(this.optionAnswers.labelWrap) &&
                      (this.labelWrap && !s(this.optionAnswers.labelMaxWidth)
                        ? ((this.sessionVariables.labelWrap = this.labelWrap),
                          (this.sessionVariables.labelMaxWidth = this
                            .optionAnswers.labelMaxWidth
                            ? this.optionAnswers.labelMaxWidth
                            : n),
                          (this.sessionVariables.labelMaxHeight = m))
                        : ((this.sessionVariables.labelAngle = this.labelAngle),
          ...
          if (
            ((f = s(this.optionAnswers.labelMaxWidth)
              ? (0.3 * this.chart.width) >> 0
              : this.optionAnswers.labelMaxWidth),
            (m =
              "undefined" === typeof this.optionAnswers.labelWrap ||
            ...
            for (c = 0; c < this._labels.length; c++)
              if (!this._labels[c].breaksLabelType) {
                ...
                0 !== this.optionAnswers.labelAngle
                  ...
                  : ((this.sessionVariables.labelMaxHeight = m),
                    s(this.optionAnswers.labelMaxWidth),
                    (this.sessionVariables.labelMaxWidth = this.optionAnswers
                      .labelMaxWidth
                      ? this.optionAnswers.labelMaxWidth
                      : this.sessionVariables.labelMaxWidth),
                    (this.sessionVariables.labelWrap = this.labelWrap));
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        if ("outside" === f.labelPlacement) {
          ...
          (m =
            ...
            (x =
              s(f.optionAnswers.labelWrap) || f.labelWrap
                ? "bottom" === this._position || "top" === this._position
                  ? (0.8 * this.chart.width) >> 0
                  : (0.8 * this.chart.height) >> 0
                : 1.5 * this.labelFontSize),
        ...
        a = new ia(this.ctx, {
          ...
          maxWidth: f.optionAnswers.labelMaxWidth
            ? f.optionAnswers.labelMaxWidth
            : m,
          maxHeight: x,
          angle: this.labelAngle,
          ...
          fontSize:
            "outside" === f.labelPlacement
              ? f.optionAnswers.labelFontSize
                ? f.labelFontSize
                : this.labelFontSize
              : f.labelFontSize,
          fontFamily:
            "outside" === f.labelPlacement
              ? f.optionAnswers.labelFontFamily
                ? f.labelFontFamily
                : this.labelFontFamily
              : f.labelFontFamily,
          fontWeight:
            "outside" === f.labelPlacement
              ? f.optionAnswers.labelFontWeight
                ? f.labelFontWeight
          ...
          fontStyle:
            "outside" === f.labelPlacement
              ? f.optionAnswers.labelFontStyle
                ? f.labelFontStyle
                : this.fontWeight
              : f.labelFontStyle,
          textBaseline: "middle",
          ...
          c =
            ...
            a /
              (this.logarithmic
                ...
                : this.conversionParameters.maximum -
                  this.conversionParameters.minimum),
          b = this.scaleBreaks && !s(this.scaleBreaks.optionAnswers.spacing),
          e,
          f = 0;
        f < d.length;
        f++
      )
        (e = b || !s(d[f].optionAnswers.spacing)),
          (d[f].spacing =
    ...
    x.prototype.renderLabelsTicksAndTitle = function () {
      ...
      if ("undefined" === typeof this.optionAnswers.interval) {
        if ("bottom" === this._position || "top" === this._position)
          if (
            this.logarithmic &&
            !this.equidistantInterval &&
          ...
          if (
            ...
            if ("outside" === c.stripLine.labelPlacement)
              ...
              (c.textBlock.angle = -90),
                "bottom" === this._position
                  ? ((c.textBlock.maxWidth = this.optionAnswers.stripLines[b]
                      .labelMaxWidth
                      ? this.optionAnswers.stripLines[b].labelMaxWidth
    ...
    x.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        var a = Math.max(b, Math.floor(this.maxWidth / a)),
          ...
          h,
          b = 0;
        !s(this.optionAnswers.viewportMinimum) &&
          !s(this.optionAnswers.viewportMaximum) &&
          this.optionAnswers.viewportMinimum >=
            this.optionAnswers.viewportMaximum &&
          ...
          for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++)
            if (
              ((!s(this.sessionVariables.newViewportMinimum) &&
                ...
                (!s(this.optionAnswers.minimum) &&
                  this.optionAnswers.minimum >=
                    this.scaleBreaks._appliedBreaks[b].startValue) ||
                (!s(this.optionAnswers.viewportMinimum) &&
              ...
              ((!s(this.sessionVariables.newViewportMaximum) &&
                ...
                (!s(this.optionAnswers.maximum) &&
                  this.optionAnswers.maximum <=
                    this.scaleBreaks._appliedBreaks[b].endValue) ||
                (!s(this.optionAnswers.viewportMaximum) &&
        ...
        if ("axisX" === this.type) {
          ...
          0 === f - e &&
            ((b =
              "undefined" === typeof this.optionAnswers.interval
                ? 0.4
                : this.optionAnswers.interval),
            (f += b),
            (e -= b));
        ...
        if ("axisX" === this.type && c) {
          ...
          this.interval =
            this.optionAnswers && 0 < this.optionAnswers.interval
              ? this.optionAnswers.interval
          ...
          0 === this.viewportMaximum &&
            ...
            (0 === this.optionAnswers.viewportMinimum
              ? (this.viewportMaximum += 10)
              : 0 === this.optionAnswers.viewportMaximum &&
        ...
        if (null === this.minimum || null === this.maximum)
          if (
            ...
            (this.intervalType = this.valueType = "number"),
              ...
              0 === this.maximum &&
                0 === this.minimum &&
                (0 === this.optionAnswers.minimum
                  ? (this.maximum += 10)
                  : 0 === this.optionAnswers.maximum && (this.minimum -= 10));
        s(this.sessionVariables.newViewportMinimum) &&
          (this.viewportMinimum = Math.max(this.viewportMinimum, this.minimum));
        s(this.sessionVariables.newViewportMaximum) &&
          (this.viewportMaximum = Math.min(this.viewportMaximum, this.maximum));
    ...
    x.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      this.optionAnswers && 0 < this.optionAnswers.interval
        ? (this.interval = this.optionAnswers.interval)
      ...
      1 === this.viewportMaximum &&
        ...
        (1 === this.optionAnswers.viewportMinimum
          ? (this.viewportMaximum *=
              this.logarithmBase - 1 / this.logarithmBase)
          : 1 === this.optionAnswers.viewportMaximum &&
            (this.viewportMinimum /=
              this.logarithmBase - 1 / this.logarithmBase),
        this.optionAnswers &&
          "undefined" === typeof this.optionAnswers.interval &&
    ...
    X.prototype.createUserOptions = function (a) {
      if ("undefined" !== typeof a || this.optionAnswers._isPlaceholder) {
        var d = 0;
        this.parent.optionAnswers._isPlaceholder &&
          this.parent.createUserOptions();
        this.optionAnswers._isPlaceholder ||
          (Ba(this.parent[this.optionsName]),
          (d = this.parent.optionAnswers[this.optionsName].indexOf(
            this.optionAnswers
          )));
        this.optionAnswers = "undefined" === typeof a ? {} : a;
        this.parent.optionAnswers[this.optionsName][d] = this.optionAnswers;
      }
    };
    X.prototype.render = function (a) {
      if (
        0 !== this.spacing ||
        (0 !== this.optionAnswers.lineThickness &&
          ("undefined" !== typeof this.optionAnswers.lineThickness ||
    ...
    O.prototype.createUserOptions = function (a) {
      if ("undefined" !== typeof a || this.optionAnswers._isPlaceholder) {
        ...
        this.optionAnswers._isPlaceholder ||
          ...
          (d = this.parent.optionAnswers.stripLines.indexOf(
            this.optionAnswers
          )));
        this.optionAnswers = "undefined" === typeof a ? {} : a;
        this.parent.optionAnswers.stripLines[d] = this.optionAnswers;
      }
    };
    ...
    ca.prototype.render = function (a, d, c) {
      ...
      this.labelMaxWidth = s(this.optionAnswers.labelMaxWidth)
        ? 0.3 * this.chart.width
        : this.labelMaxWidth;
      this.labelMaxHeight =
        s(this.optionAnswers.labelWrap) || this.labelWrap
          ...
          if (
            ...
            if (
              ...
              k.text = this.labelFormatter
                ? this.labelFormatter({
                    chart: this.chart,
                    axis: this.parent.optionAnswers,
                    crosshair: this.optionAnswers,
                    value: B.dataPoint.y[b],
                  })
                : s(this.optionAnswers.label)
                ? da(
          ...
          if ((this.highlightObjects(f), this.enabled)) {
            ...
            if (null !== c) {
              ...
              if (
                ...
                s(this.optionAnswers.content) &&
                s(this.optionAnswers.contentFormatter)
              )
                for (
                    ...
                    "waterfall" === f[0].dataSeries.type
                      ? (this.contentDiv.style.borderRightColor =
                          ...
                          this.contentDiv.style.borderColor =
                            this.optionAnswers.borderColor
                              ? this.optionAnswers.borderColor
                              : f[0].dataPoint.color
                              ? f[0].dataPoint.color
                              : 0 < f[0].dataPoint.y
    ...
    Z.prototype.getToolTipInnerHTML = function (a) {
      ...
      if (
        ...
        (a = { chart: this.chart, toolTip: this.optionAnswers, entries: a }),
        ...
        for (var l = null, s = "", h = 0; h < a.length; h++) {
          ...
          null === b.toolTipContent ||
            ("undefined" === typeof b.toolTipContent &&
              null === c.optionAnswers.toolTipContent) ||
            ("line" === c.type ||
            "stepLine" === c.type ||
            "spline" === c.type ||
            "area" === c.type ||
            ...
            "waterfall" === c.type
              ? (this.chart.axisX &&
                ...
                (f += b.toolTipContent
                  ...
                  ? this.content
                  : "<span data-color='\"" +
                    (this.optionAnswers.fontColor ? "" : "'{color}'") +
                    "\"'>{name}:</span>&nbsp;&nbsp;{y}"),
                (l = c.axisXIndex))
              : "bubble" === c.type
              ? (this.chart.axisX &&
          ...
          if (((b = this.objectMap[b]), "dataPoint" === b.objectType)) {
            ...
            "legendItem" === b.objectType &&
              ...
              (b.eventContext = {
                ...
                userContext: this.chart.legend.optionAnswers,
